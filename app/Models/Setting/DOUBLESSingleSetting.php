...
class SingleSetting
{
	...
	public static function getValues($value, $disk)
	{
		if (empty($value)) {
			...
			$value['max_word_description'] = '400';
			$value['min_word_description'] = '30';
			$value['title_character_limit'] = '50';
			$value['title_character_minimum_limit'] = '5';
			$value['activation_facebook_comments'] = 0;
			$value['show_post_on_googlemap'] = 0;
		} else {
			...
			if (!isset($value['max_word_description'])) {
				$value['max_word_description'] = '400';
			}
			if (!isset($value['min_word_description'])) {
				$value['min_word_description'] = '30';
			}
			if (!isset($value['title_character_limit'])) {
				$value['title_character_limit'] = '50';
			}
			if (!isset($value['title_character_minimum_limit'])) {
				$value['title_character_minimum_limit'] = '5';
			}
			if (!isset($value['show_post_on_googlemap'])) {
				$value['show_post_on_googlemap'] = 0;
			}
			if (!isset($value['activation_facebook_comments'])) {
				$value['activation_facebook_comments'] = 0;
			}
		}
	...
	public static function getFields($diskName)
	{
		$fields = [
			...
			[
				...
				'label'             => trans('admin.Title Character Limit'),
				'type'              => 'text',
				'hint'              => trans('admin.Maximum Title Character Limit'),
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			[
				'name'              => 'title_character_minimum_limit',
				'label'             => trans('admin.Title Character Minimum Limit'),
				'type'              => 'text',
				'hint'              => trans('admin.Minimum Title Character Limit'),
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
		...
		$fields = array_merge($fields, [
			...
			[
				'name'              => 'max_word_description',
				'label'             => trans('company-admin.max_word_description'),
				'type'              => 'text',
				'attributes'        => [
					'placeholder' => trans('company-admin.max_word_description'),
				],
				'hint'              => trans('company-admin.max_word_description_hint'),
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			[
				'name'              => 'min_word_description',
				'label'             => trans('company-admin.min_word_description'),
				'type'              => 'text',
				'attributes'        => [
					'placeholder' => trans('company-admin.min_word_description'),
				],
				'hint'              => trans('company-admin.min_word_description_hint'),
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
