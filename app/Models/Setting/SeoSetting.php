...
{	
	public static function getValues($value, $disk)
	{
		if (empty($value)) {
			...
			$value['min_keyword_generate'] = 150;
			$value['mxx_keyword_generate'] = 160;
			...
			if (!isset($value['min_keyword_generate'])) {
				$value['min_keyword_generate'] = 150;
			}
			if (!isset($value['mxx_keyword_generate'])) {
				$value['mxx_keyword_generate'] = 160;
			}
	...
	public static function getFields($diskName)
	{
		$fields = [
			...
			/* Indexing Business Type Start*/
			[
				'name'  => 'separator_clear_2',
				'type'  => 'custom_html',
				'value' => trans('admin.seo_html_indexing_business_type'),
			],
			[
				'name'              => 'index_private',
				'label'             => trans('admin.private_individual'),
				'type'              => 'checkbox',
				'wrapperAttributes' => [
			...
			[
				...
				'label'             => trans('admin.professional'),
				'type'              => 'checkbox',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-3',
				],
	...
	[
		...
		'type'  => 'custom_html',
		'value' => trans('admin.keyword_generator'),
	],
	[
		'name' => 'min_keyword_generate',
		'label' => trans('admin.min_keyword_generate_label'),
		'type' => 'text',
		'hint' => trans('admin.min_keyword_generate_hint'),
		'wrapperAttributes' => ['class' => 'form-group col-md-6',],
	],
	[
		'name' => 'mxx_keyword_generate',
		'label' => trans('admin.max_keyword_generate_label'),
		'type' => 'text',
		'hint' => trans('admin.max_keyword_generate_hint'),
		'wrapperAttributes' => ['class' => 'form-group col-md-6',],
	],
