...
class GetLatestPosts
{
	...
	public static function getFields($diskName)
	{
		$fields = [
            ...
            [
                'name'              => 'physical_product_items',
                'label'             => trans('admin.physical_product_items'),
                'type'              => 'number',
                'wrapperAttributes' => [
            ...
            [
                'name'              => 'service_product_items',
                'label'             => trans('admin.service_product_items'),
                'type'              => 'number',
                'wrapperAttributes' => [
                    'class' => 'form-group col-md-4',
                ],
            ...
            [
                'name'              => 'digital_product_items',
                'label'             => trans('admin.digital_product_items'),
                'type'              => 'number',
                'wrapperAttributes' => [
                    'class' => 'form-group col-md-4',
                ],
