...
use App\Models\Post\SimilarByRandom;
use App\Models\Post\SimilarByVendor;
...
{
	use Crud, CountryTrait, Notifiable, HasFactory, LatestOrPremium, SimilarByCategory, SimilarByLocation, SimilarByVendor, SimilarByRandom;
	...
	*/
	...
	public function indexingHistory()
	{
		return $this->hasOne(IndexingHistory::class, 'reference_id')->where("type","posts");
	}
	public function durations()
{
    return $this->hasMany(PostDuration::class);
}
