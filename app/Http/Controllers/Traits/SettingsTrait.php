	...
	public function applyFrontSettings()
	{
		...
		*/
        ...
        if (!headers_sent()) {
            ...
            // Output an error or log a message indicating that the headers have already been sent.
            // This will help identify the cause of the issue.
            echo "Headers already sent. Cannot set cookie.";	
        }
		// Skin selection
