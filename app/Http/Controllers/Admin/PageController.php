	...
	public function setup()
	{
		...
		*/
        ...
        $this->xPanel->addField([
            ...
            'label'      => mb_ucfirst(trans('admin.meta_description')),
            'type'       => 'textarea',
            'attributes' => [
                'placeholder' => mb_ucfirst(trans('admin.enter_meta_description')),
                'maxlength'   => 300, // limit in the HTML as well
                'data-maxlength' => 300,
            ],
            'wrapper'    => [
                'class' => 'form-group col-md-6',
        ...
        $this->xPanel->addField([
            'name'       => 'meta_keywords',
            'label'      => mb_ucfirst(trans('admin.meta_keywords')),
            'type'       => 'text',
            'attributes' => [
                'placeholder' => mb_ucfirst(trans('admin.enter_meta_keywords')),
            ],
        ]);
