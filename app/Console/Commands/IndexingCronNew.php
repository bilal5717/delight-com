...
class IndexingCronNew extends Command
{
	 ...
	 * @var string
	 */
	protected $signature = 'indexing_all:cron';
	 ...
	 * @var string
	 */
	protected $description = 'Add newly created or updated urls to google indexing and bing indexing';
