...
class UrlGen
{
    public static function generatePostUrl($post) {
        // Your implementation for generating post URL
        return url(UrlGen::postUri($post));
    }

    public static function generateCategoryUrl($category) {
        // Your implementation for generating category URL
        return url(UrlGen::category($category, null, null, $category->parent));
    }
    ...
    public static function passwordResetPath()
    {
        return config('routes.passwordReset');
    }

	public static function passwordReset()
	{
		return url(self::passwordResetPath());
	}
}
