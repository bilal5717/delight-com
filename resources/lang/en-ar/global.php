...
return [
    'free_local_classified_ads_in_the_world' => 'Free Global Ecommerce for people like you and me',
    ...
    '100_percent_free_local_classified_ads' => '100% Free product ads',
    'free_ads_in_the_world' => 'Free product ads in the World',
    ...
    'post_free_ads' => 'Sell Anything-Post Ads',
    'start_now' => 'Start Now!',
    ...
    'login_for_faster_access_to_the_best_deals' => '<a href=":login_url"><strong>Login</strong></a> for faster access to the best deals. <a href=":register_url"><strong>Click here</strong></a> if you don\'t have an account. <strong>Now you can sell like anyone else, make your online shop with us -free forever.</strong>',
    'list_of_categories_and_sub_categories' => 'List of Categories and Sub-categories',
    'list_of_cities_in' => 'List of Cities in',
    'do_have_anything_to_sell_or_rent' => 'Do have anything to sell, rent or give away?',
    ...
    'Browse' => 'Browse',
    'add_up_to_x_pictures_text' => 'Add up to :pictures_number pictures (pixes 620x465). Use real pictures of your product, not catalogs. Legally registered companies can use catalog images',
    ...
    'sell_quickly_advice_1' => 'If you have many products - List each product separately - Use a long title and description for the product - Size, price, material from which it is made, etc. Do not forget to specify important details. - Nobody wants to buy a product that does not have enough details',
...
If your ads don\'t have a price and you want to give this item to someone else for free, list it under "donate - giving for free" so someone can recycle it.',
    ...
    'welcome_to_app_100_free' => 'Welcome to :appName : 100% Free Consumer Products Ads. Sell and buy near you. Simple, fast and efficient.',
    ...
    'Check the item before you buy' => 'Choose sellers who earned good comments and verified sellers',
    'Pay only after collecting the item' => 'Use our recommended payment methods to pay or visit the store in person',
    'Know more' => 'Know more',
    ...
    'of' => 'of',
    'from' => 'from',
    'Post saved in favorites successfully' => 'Ad saved in favorites successfully!',
    'Post deleted from favorites successfully' => 'Ad deleted from favorites successfully !',
    ...
    'Reload' => 'Reload',
    'cookie_consent_message' => 'Your experience and load speed on this site will be improved by allowing cookies.',
