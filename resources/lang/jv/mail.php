...
return [
    ...
    'Hello!' => 'Hello!',
    'Regards' => 'Regards',
    'having_trouble_on_link' => 'If you\'re having trouble clicking the ":actionText" button, copy and paste the URL below into your web browser:',
    'All rights reserved.' => 'All rights reserved.',
    'footer_salutation' => 'Best Regards,<br>:appName',
    'mail_footer_content' => 'This is your new, free global e-commerce platform that allows you to buy and sell products locally or internationally. With this platform, you can connect with buyers and sellers from around the world',
    ...
    <br>
    <br>
    If you are planning to advertise your products and services, please watch our guideline video.
    <br>
    Lists of products or services that do not comply with our guidelines may be removed from our website.
    <br>
    https://www.youtube.com/channel/UCGb5QJhQr4ji3JR7fJysMKw.
    <br>',
    
    // Post activation messages
    ...
    <br>
    Don\'t let your ad get deleted-
    Read our FAQs to understand how you can benefit from NEWTOUSE',
    
    // Post reviewed messages
    ...
    // Republished Ad Email
    'post_republished_title' => 'Your ad has been re-published',
    'post_republished_content_1' => 'Hello,',
    'post_republished_content_2' => 'Congratulations, your ad titled <a href=":postUrl">:title</a> is now online.
    <br>
    To ensure that potential buyers can reach you directly, please make sure to update your phone number in the international format on your ad.
    <br>
    For example, if your number is based in the UK, it should be formatted as +44 21 221552242 ( +Country code -Prefix-Mobile Number).
    <br>
    Additionally, please remember to update your chat app ID on your ad by going to your dashboard, editing your ad, and clicking on the "Chat with seller" option. This will allow people to contact you directly through the chat apps you have selected.
    <br>',
    ...
    'post_seller_contacted_content_3' => 'NOTE: Please note that by default, the person who contacts you will not have access to your email address until you initiate contact with them. However, you have the option to change your settings in your user profile to show or hide your email when replying to messages.',
    'post_seller_contacted_content_4' => 'It\'s important to always verify the details of the person you are in contact with such as their name, address, and other relevant information. This will ensure that you have a way to contact them in case of any disputes that may arise. Additionally, it\'s highly recommended to choose a shipping method that is either handled by yourself or a reputable shipping company. This will help ensure that your item arrives safely and on time to the intended recipient.',
    'post_seller_contacted_content_5' => 'It\'s important to be cautious of offers that seem too good to be true. Be especially wary of requests from individuals abroad who only have a contact email, as these types of requests may be fraudulent. The bank transfer methods such as Western Union or MoneyGram that they propose may be fake. To ensure the safety of your transaction, it\'s best to conduct business with verified and reputable companies rather than individuals. Be sure to verify the authenticity of any offers before proceeding with any transactions.',
    ...
    <br>
    <br>
    Before advertising any product, be sure to read our FAQs and follow our guidelines for Youtube videos. You can find the Youtube channel in our social links at the bottom of this website.
    <br>',
    'user_activated_content_3' => 'Congratulations, your account has been activated! <br> <br> Before you start advertising any products, it\'s important to familiarize yourself with our FAQs and guidelines. You can find these resources on our website. Additionally, we also have Youtube videos that can be helpful in understanding how to advertise your products effectively. You can access our Youtube channel by clicking on the Google or Youtube icon at the bottom of our website.
    <br>',
    'user_activated_content_4' => '<strong>Note: The :appName team strongly recommends that you:</strong> <br><br>
    1 - Always be cautious of advertisers who refuse to show you the item they are offering for sale or rental. <br>
    2 - Never send money through Western Union or other international mandates.
    <br><br>
    If you have any doubts about the credibility of an advertiser, please contact us immediately or report the advertiser. We will then take action as quickly as possible to prevent someone less informed from becoming a victim. 
    <br>
    We want everyone to feel safe when using :appName, so we rely on your support to identify and eliminate any sellers or buyers with bad intentions. 
    <br>',
    ...
    // Notifications for when a new abuse report is sent
    'contact_form_title' => 'New message from :appName',
    'post_report_sent_title' => 'New abuse report',
    'Post URL' => 'Post URL',

    // Notifications for when an ad is archived
    ...
    // Notifications for when an ad will be deleted
    ...
    // Notifications for when a new ad is posted
    ...
    // Notifications for when a new user registers
    ...
    // Notifications for when a payment is sent
    ...
    // Notifications for when a new payment is made
    ...
    // Notifications for when a payment is approved
    ...
    // Notifications for when a new account is created
    ...
    'generated_password_content_6' => 'You\'re receiving this email because you recently created a new :appName account or added a new email address to your existing account. If you did not initiate this action, please disregard this email.
    <br> 
    <br> 
    If you plan on advertising your products or services on our platform, it is important that you familiarize yourself with our guidelines first. To help you with this, we have created a guideline video which can be found on our Youtube channel by clicking on the following link: 
    <br>
    https://www.youtube.com/channel/UCGb5QJhQr4ji3JR7fJysMKw. 
    <br>
    Additionally, you can also refer to our FAQ page for more information: https://www.newtouse.com/page/faq',
];