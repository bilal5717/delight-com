                    ...
                    <div class="inner-box default-inner-box">
                        ...
                        <div class="card card-default mt-3">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a href="{{ route('company_address') }}">{{ t('company_address') }}</a>
                                </h4>
                            </div>
                                ...
                                <div class="card-body">
                                    <form name="details" class="form-horizontal" role="form" method="POST"
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-9">
                                                <input name="address" type="text" id="address"
                                                    placeholder="{{ t('address') }}" value="{{ $company_address->address }}"
                                        ...
                                        <div id="cityBox" class="form-group row">
                                            <label class="col-md-3 col-form-label" for="city_id">{{ t('company_city') }}
                                                <sup>*</sup></label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-9">
                                                <input name="state" type="text" id="state"
                                                    placeholder="{{ t('company_state') }}" value="{{ $company_address->address }}"
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-9">
                                                <input name="pincode" type="text" id="pincode"
                                                    placeholder="{{ t('company_pincode') }}" value="{{ $company_address->pincode }}"
