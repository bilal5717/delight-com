                    ...
                    <div class="inner-box default-inner-box">
                        ...
                        <div class="card card-default mt-3">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a href="#addressPanel" data-toggle="collapse"
                                        data-parent="#accordion">{{ t('shipping_address') }}</a>
                                </h4>
                            </div>
                            <div class="panel-collapse collapse {{ (old('panel') == '' or old('panel') == 'addressPanel') ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <form name="details" class="form-horizontal" role="form" method="POST"
                                        action="{{ route('save_shipping_address') }}" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input name="address_title" type="text" id="address_title"
                                                    placeholder="{{ t('address_title') }}" value="{{ old('address_title') }}"
                                                    class="form-control @error('address_title') is-invalid @enderror" autofocus>
                                                @error('address_title')
                                        ...
                                        <div id="cityBox" class="form-group row required">
                                            <label class="col-md-3 col-form-label{{ $cityIdError }}"
                                                for="city_id">{{ t('company_city') }} <sup>*</sup></label>
                                            <div class="col-md-9">
                                                <select id="city" name="city_id"
                                                    class="form-control sselecter{{ $cityIdError }}" required>
                                                    <option value="0"
                                            ...
                                            <div class="col-md-9">
                                                <select name="country" id="country" class="form-control sselecter @error('country') is-invalid @enderror">
                                                    @foreach ($countries as $ctry)
                                                        <option {{$ctry->code === $country['code'] ? 'selected' : ''}} value="{{ $ctry->code }}">
                                                            {{ $ctry->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="offset-md-3 col-md-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            {{ (is_array('default_address') and in_array(1, 'default_address')) ? ' checked' : '' }}
                                                            name="default_address" value="1" id="flexCheckChecked">
                                        ...
                                        @else
                                            <input type="hidden" name="default_address" id="default_address" value="true">
                                        @endif
                                        <!-- Button -->
                                        <div class="form-group row">
                                            <div class="offset-md-3 col-md-9">
...
@section('after_scripts')
    ...
    <script>
        var country = "{{ old('country', $country['code']) }}";
    </script>
...
@section('after_scripts')
    <script>
        $('.default_address').on('change', function(event) {
            alert(event);
        })
    </script>
@endsection
