                            ...
                            <div class="card-header">
                                ...
                                <h4 class="card-title">
                                    ...
                                    <a href="#paymentPanel" data-toggle="collapse"
                                        ...
                                        data-parent="#accordion">{{ t('company_payment_details') }}</a>
                            ...
                            <div class="panel-collapse collapse {{ (old('panel') == '' or old('panel') == 'paymentPanel') ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <form name="details" class="form-horizontal" role="form" method="POST"
                                        ...
                                        action="{{ route('update-company-payment', ['id' => $company_payment->id]) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-md-3 col-form-label">{{ t('select_currency') }}
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <select id="currency" name="currency" class="form-control" disabled>
                                                    ...
                                                    <option value="{{ $company_payment->currency_code }}">

                                                        {{ $company_payment->currency_code }}

                                                        - {{ $company_payment->currency->name }}</option>

                                                    @foreach ($currencies as $field)

                                                        <option data-id="{{ $company_payment->currency->id }}" value="{{ $field->code }}">{{ $field->code }} -
...
@section('after_scripts')
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                method: 'GET',
                url: "{{ url('account/company-payment') }}/{{$company_payment->currency_code}}/{{$company_payment->id}}",
