                                ...
                                <div class="table-action">
                                    <label for="checkAll">
                                        ...
                                        <button type="submit" class="upgrade btn btn-sm btn-default">
                                            <i class="fas fa-arrow-alt-circle-up"></i> {{ trans('company.upgrade_post_package') }}
                                        </button>
                                    </label>
...
@section('after_scripts')
    ...
    <script>
        $('a.upgrade, button.upgrade, a.confirm-action').click(function(e) {
            e.preventDefault();
            var arr = $('[name="entries[]"]:checked').map(function(e) {
                return this.value;
            }).get();
            ...
            if (arr) {
                var url = "{{route('upgrade-post',['ids'=> '%postids%'])}}";

                if (url !== 'undefined') {
                    redirect(url.replace("%postids%",arr.join(",")));
                }
