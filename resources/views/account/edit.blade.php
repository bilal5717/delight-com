                        ...
                        <div class="row">
                            <div class="col-md-5 col-xs-4 col-xxs-12">
                                <h3 class="no-padding text-center-480 useradmin">
                                    <a href="">
                                        <img id="userImg" class="userImg" src="{{ asset('storage/' . $user->photo) }}"
                                            alt="user">&nbsp;
                                        {{ $user->name }}
                                    </a>
                                </h3>
                                                    ...
                                                    <select name="country_code"
                                                        ...
                                                        @foreach ($countries as $item)
                                                            <option value="{{ $item->get('code') }}"
                                                                {{ old('country_code', $user->country_code) == $item->get('code') ? 'selected="selected"' : '' }}>
                                                                {{ $item->get('name') }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            */
                                            ...
                                            @if ($user->company)
                                                ...
                                                <div class="form-group row required primaryEmail">
                                                    <label class="col-md-3 col-form-label">Select Primary Email</label>
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="form-check form-check-inline pt-2 mb-4">
                                                            ...
                                                            <label class="form-check-label" for="primary_email1">
                                                                {{ $user->email }}
                                                            </label> &nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <label class="form-check-label" for="primary_email2">
                                                                {{ $user->company ? $user->company->email : '' }}
                                                            </label>
                                                        </div>
                                                        <b class="d-block">{{trans("All the email notifications will be sent to primary email.")}}</b>
                                                    </div>
                                                </div>
                                            @endif
...
@section('after_scripts')
    ...
    <script>
        ...
        $('#photoField').fileinput({
            ...
            defaultPreviewContent: '<img src="{{ !empty($gravatar) ? $gravatar : url('images/user.jpg') }}" alt="{{ t('Your Photo or Avatar') }}">' +
                photoInfo,
        ...
        $('#photoField').on('filedeleted', function() {
            $('#userImg').attr({
                'src': '{!! !empty($gravatar) ? $gravatar : url('images/user.jpg') !!}'
            });
