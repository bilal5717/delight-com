...
@section('after_scripts')
    <script>
        $(document).ready(function() {
            ...
            let physical_product_items = $('#physical_product_items').val();
            let service_product_items = $('#service_product_items').val();
            let digital_product_items = $('#digital_product_items').val();

            let total_sum = parseInt(physical_product_items) + parseInt(service_product_items) + parseInt(digital_product_items);
            setTimeout(function(){
                if(parseInt(max_items) < total_sum){
                    $('#physical_product_items').addClass("is-invalid").removeClass("is-valid");
                    $('#service_product_items').addClass("is-invalid").removeClass("is-valid");
                    $('#digital_product_items').addClass("is-invalid").removeClass("is-valid");
                    alert("Total sum of the Physical, Service and Digital Product values shouldn't be greater then the 'Max Items'");
                }
                else {
                    $('#physical_product_items').addClass("is-valid").removeClass("is-invalid");
                    $('#service_product_items').addClass("is-valid").removeClass("is-invalid");
                    $('#digital_product_items').addClass("is-valid").removeClass("is-invalid");
                }
            }, 500);
