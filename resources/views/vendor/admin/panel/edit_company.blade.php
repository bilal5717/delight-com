    ...
    <div class="row page-titles">
        <div class="col-md-7 col-12 align-self-center d-none d-md-block">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active">{{ trans('company-admin.edit-company') }}</li>
            </ol>
        </div>
    </div>
@endsection
                    ...
                    <div id="accordion" class="panel-group">
                        ...
                        <div class="card card-default">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a href="#businessPanel" aria-expanded="true" data-toggle="collapse"
                                        data-parent="#accordion">{{ trans('company.edit_company_details') }}</a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-collapse collapse {{ (old('panel') == '' or old('panel') == 'businessPanel') ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <form name="details" class="form-horizontal" role="form" method="POST"
                                        action="{{ route('update-company') }}" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-9">
                                                <input name="instagram" type="text" class="form-control"
                                                    value="{{ old('instagram', Auth::user()->company->instagram) }}"
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-9">
                                                <input name="kvk" type="text" class="form-control"
                                                    value="{{ old('kvk', Auth::user()->company->kvk) }}"
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-9">
                                                <input name="wechat" type="text" class="form-control"
                                                    value="{{ old('wechat', Auth::user()->company->wechat) }}"
                                        ...
                                        <div class="form-group row ">
                                            <label
                                                ...
                                                <sup class="sup">*</sup></label>
                                            <div class="col-md-9">
                                                <select id="categoryId" class="form-select form-control"
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-9">
                                                <select id="revenue" class="form-select form-control" name="revenue"
                                                    ...
                                                    <option value="3">100,000- 500,000USD</option>
                                                    <option value="4">500,000-1000,000 USD</option>
                                                    <option value="5">1000,000USD-10,000,000USD</option>
                                                    <option value="6">10,000,000USD ></option>
                                                </select>
                                            </div>
                                        </div>
