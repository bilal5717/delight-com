...
@endif
@if (auth()->user()->can('monthly-image-list') || userHasSuperAdminPermissions())
	<li class="sidebar-item">
		<a href="{{ admin_url('monthly-image') }}" class="sidebar-link">
		<i class="mdi mdi-adjust"></i> <span class="hide-menu">Monthly Images</span>
		</a>
	</li>
@endif
