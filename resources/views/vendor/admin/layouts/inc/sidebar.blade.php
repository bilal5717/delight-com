			...
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					@if (
						...
						|| auth()->user()->can('product-type-list')
						...
						<li class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse first-level">
								...
								@endif
								@if (auth()->user()->can('product-type-list') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
										<a href="{{ admin_url('product_types') }}" class="sidebar-link">
											<i class="mdi mdi-adjust"></i>
											<span class="hide-menu">{{ trans('admin.product types') }}</span>
										</a>
									</li>
								@endif
								...
								@endif
								@if (auth()->user()->can('indexing-list') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
										<a href="{{ admin_url('indexing/status') }}" class="sidebar-link">
											<i class="mdi mdi-adjust"></i>
											<span class="hide-menu">{{ trans('admin.indexing info') }}</span>
										</a>
									</li>
								@endif
							</ul>
					...
					@endif
					@if (auth()->user()->can('help-list') || userHasSuperAdminPermissions())
						<li class="sidebar-item">
							<a href="{{ admin_url('service_settings') }}" class="sidebar-link">
								<i data-feather="help-circle" class="feather-icon"></i> <span class="hide-menu">{{ trans('admin.service_configuration_Setting') }}</span>
							</a>
						</li>
					@endif
					{!! $pluginsMenu !!}
