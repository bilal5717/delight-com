...
@section('content')
    ...
    @include('common.structure-inc', ['pageTitle' => "create", "pageUrl" => "create"])
                    ...
                    <div class="inner-box category-content">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <form class="form-horizontal" id="postForm" method="POST"
                                    ...
                                    <fieldset>
                                                        ...
                                                        <div class="form-check form-check-inline pt-2">
                                                            <input name="product_type_id"
                                                                   ...
                                                                   class="form-check-input{{ $productTypeIdError }}"
                                                                    {{ old('product_type_id') == $productType->id
                                                                        ? ' checked="checked"'
                                                                        : (auth()->check() &&
                                                                        !empty(auth()->user()->company) &&
                                                                        auth()->user()->company->default_business_type == $productType->id
                                                                            ? ' checked="checked"'
                                                                            : '') }}>
                                                            ...
                                                            <div class="form-check form-check-inline pt-2">
                                                                <input name="post_type_id"
                                                                       ...
                                                                       class="form-check-input{{ $postTypeIdError }}"
                                                                        {{ old('post_type_id') == $postType->id
                                                                            ? ' checked="checked"'
                                                                            : (auth()->check() &&
                                                                            !empty(auth()->user()->company) &&
                                                                            auth()->user()->company->default_business_type == $postType->id
                                                                                ? ' checked="checked"'
                                                                                : '') }}>
                                                                <label class="form-check-label"
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <small id="" class="form-text text-muted input-hint">
                                                    ...
                                                    <span
                                                            class="float-right input-hint ">{!! t('total_title_characters', ["count_characters" => 0]) !!}</span>
                                                </small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="{{ $descriptionColClass }}">
                                                <textarea class="form-control{{ $descriptionError }}" placeholder="{{t('Describe your job')}}" id="description" name="description" rows="15">{{ old('description') }}</textarea>
                                                <small id=""
                                                       class="form-text text-muted">{{ t('describe_what_makes_your_ad_unique') }}...
                                                    <span
                                                            class="float-right input-hint ">{{ t('min_max_word_description') }}</span>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="{{ $summariesColClass }}">
                                                <textarea class="form-control{{ $summariesError }}"
                                                          ...
                                                          maxlength="{{ config('settings.seo.mxx_keyword_generate') }}"
                                                    ...
                                                    @for ($i = 1; $i <= $picturesLimit; $i++)
                                                        <div class="mb-2 <?php echo $errors->has('pictures.' . $i) ? 'is-invalid' : ''; ?>">
                                                            <div class="file-loading">
                                                                <input id="picture{{ $i }}" name="pictures[]"
                                                                       type="file" class="file post-picture"
                                                                       accept="image/*"
                                                                       data-msg-placeholder="{{ t('Picture X', ['number' => $i]) }}" value="{{ old('username[]') }}">
                                                            </div>
                                                        </div>
                                                    @endfor
                                                    ...
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                                            <input id="negotiable" name="negotiable" type="checkbox"
                                                                   value="1"
                                                                {{ old('negotiable') == '1' ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('negotiable') }}</small>
                                                        </span>
                                                    </div>
                                                </div>
                                                <small id=""
                                            ...
                                            <div class="form-group row required">
                                                ...
                                                <div class="col-md-8">
                                                    <select id="countryCode" name="country_code"
                                                        ...
                                                        <option value="0"
                                                                {{ (!old('country_code') or old('country_code') == 0) ? 'selected="selected"' : '' }}>
                                                            {{ t('select_a_country') }} </option>
                                                        @foreach ($countries as $item)
                                                            <option value="{{ $item->get('code') }}"
                                                                    {{ old('country_code', !empty(config('ipCountry.code')) ? config('ipCountry.code') : 0) == $item->get('code') ? 'selected="selected"' : '' }}>
                                    ...
                                    <div class="col-md-8">
                                        <input id="address" name="address" placeholder="{{ t('Address') }}"
                                            class="form-control input-md" type="text"
                                            value="{{ old('address') }}">
                                        <span class="help-block">{{ t('Fill an address to display on Google Maps') }}
                                        </span>
                                    </div>
                        </div>
                        @endif
                        */
                                    ?>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-check">
                                                        <input name="is_permanent" id="isPermanent"
                                                               ...
                                                               type="checkbox"
                                                                {{ old('is_permanent') == '1' ? 'checked="checked"' : '' }}>
                                        ...
                                        @else
                                            <div class="form-group row required">
                                                <label class="col-md-3 col-form-label" for="contact_name">{{ t('your_name') }}
                                                    <sup>*</sup></label>
                                                <div class="col-md-8">
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="input-group col-md-8" style="width: 100%!important;">
                                                <!-- phone_country_code -->
                                                <input id="phone_country_code" name="phone_country_code" type="hidden"
                                                       value="{{json_encode([config('country.phone'), config('country.code')])}}">
                                                <div class="select-box">
                                                    <div class="selected-option">
                                                        <div>
                                                            <span class="iconify" data-icon="flag:{{config('country.icode')}}-4x3"></span>
                                                            <span style="padding: 6px;"><strong>+{{config('country.phone')}}</strong></span>
                                                        </div>
                                                        <input type="tel" id="phone" name="phone" class="form-control" placeholder="{{ t('phone_number') }}">
                                                    </div>
                                                ...
                                                <div class="input-group-append">
                                        <span class="input-group-text">
                                            <input name="phone_hidden" id="phoneHidden" type="checkbox" value="1"
                                                {{ old('phone_hidden') == '1' ? 'checked="checked"' : '' }}>&nbsp;<small>{{ t('Hide') }}</small>
                                        </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="input-group col-md-8">
                                                ...
                                                @php
                                                    $email = !auth()->check() ? '' : (auth()->user()->primary_email ? auth()->user()->primary_email : auth()->user()->email);
                                                @endphp
                                        ...
                                        @includeFirst(
                                            [
                                                config('larapen.core.customizedViewPath') . 'layouts.inc.tools.recaptcha',
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-check">
                                                        <input name="accept_marketing_offers" id="acceptMarketingOffers"
                                                               ...
                                                               type="checkbox"
                                                                {{ old('accept_marketing_offers') == '1' ? 'checked="checked"' : '' }}>
                                        ...
                                        <div class="form-group row pt-3">
                                            <div class="col-md-12 text-center">
                                                <button id="submitPostForm" class="btn btn-primary btn-lg"> {{ t('submit') }}
                                                </button>
                                            </div>
                                        </div>
