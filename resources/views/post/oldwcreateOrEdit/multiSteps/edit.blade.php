                    ...
                    <div class="inner-box category-content">
                        <h2 class="title-2">
                            ...
                            -&nbsp;<a href="{{ \App\Helpers\UrlGen::post($post) }}" class="tooltipHere" title=""
                                ...
                                data-original-title="{!! $post->title !!}">{!! \Illuminate\Support\Str::limit($post->title, 45) !!}</a>
                        </h2>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="{{ $descriptionColClass }}">
                                                <textarea class="form-control{{ $descriptionError }}" id="description" name="description" rows="15">{{ old('description', $post->description) }}</textarea>
                                                <small id=""
