							...
							<ul id="userMenuDropdown" class="dropdown-menu user-menu dropdown-menu-right shadow-sm">
								...
								<li class="dropdown-item">
									<a href="{{ url('account/company-profile')}}">
										<i class="fas fa-briefcase"></i>  {{ trans('company.company_details') }}
									</a>
								</li>
								<li class="dropdown-item">
									<a href="{{ url('account/company-address') }}">
										<i class="far fa-building"></i>  {{ trans('company.company_address') }}
									</a>
								</li>
								<li class="dropdown-item">
									<a href="{{ url('account/company-payment')}}">
										<i class="icon-money"></i>  {{ trans('company.payment_details') }}
									</a>
								</li>
