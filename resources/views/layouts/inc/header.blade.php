...
<ul>
    <li>
        ...
        <a href="{{ url('page/destinations') }}" target="_blank">
            <div class="blink">.</div>
        </a>
    </li>
</ul>
							...
							<ul id="userMenuDropdown" class="dropdown-menu user-menu dropdown-menu-right shadow-sm">
								...
								<li class="dropdown-item">
									<a href="{{ url('account/company-profile')}}">
										<i class="fas fa-briefcase"></i>  {{ t('company_details') }}
									</a>
								</li>
								@if (auth()->check() && auth()->user()->company)
								<li class="dropdown-item">
									<a href="{{ url('account/company-address') }}">
										<i class="far fa-building"></i>  {{ t('company_address') }}
									</a>
								</li>
								<li class="dropdown-item">
									<a href="{{ url('account/company-payment')}}">
								...
								@endif
								<li class="dropdown-item"><a href="{{ url('account/working-hours') }}"><i class="icon-clock"></i> {{ t('working_hour_setting_page') }} </a></li>				<li class="dropdown-item"><a href="{{ url('account/my-posts') }}"><i class="icon-th-thumb"></i> {{ t('my_ads') }} </a></li>
    ...
    <button class="btn btn-cart" id="cartButton">
        <i class="fas fa-shopping-cart"></i>
        <span id="cartCount" class="badge bg-danger position-absolute top-0 start-100 translate-middle rounded-pill" style="display: none;">0</span>
    </button>
</li>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Optionally, refresh count periodically (e.g., every 30 seconds)
