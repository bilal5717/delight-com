...
$cssBuffer .= "\n" . '/* === Homepage: Search Form Area === */' . "\n";
$bgImgHeight = false;
if (isset($monthlyImages['height']) && !empty($monthlyImages['height'])) {
	$monthlyImages['height'] = strToDigit($monthlyImages['height']) . 'px';
	$cssBuffer .= '#homepage .wide-intro {';
	$cssBuffer .= 'height: ' . $monthlyImages['height'] . ';';
	$cssBuffer .= 'max-height: ' . $monthlyImages['height'] . ';';
	$cssBuffer .= '}';
	$bgImgHeight = true;
}
if (!$bgImgHeight) {
...
if (!$bgImgFound) {
	if (isset($monthlyImages['background_image']) && !empty($monthlyImages['background_image'])) {
		$cssBuffer .= '#homepage .wide-intro {';
		$cssBuffer .= 'background-image: url(' .  $monthlyImages['background_image'] . ');';
		$cssBuffer .= 'background-size: cover;';
		$cssBuffer .= '}';
		$bgImgFound = true;
	}
