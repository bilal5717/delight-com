...
@section('after_styles')
    @include('common.structure-inc', ['pageTitle' => "login", "pageUrl" => "login"])
    <link rel="stylesheet" href="{{ asset('css/vibrant-login.css') }}">
@endsection
    ...
    <div class="main-container vibrant-container">
        <div class="container">
            <div class="row">
                            ...
                            <div class="col-8">
                                <div class="row mb-3 d-flex justify-content-center pl-3 pr-3 vibrant-social-row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 vibrant-btn vibrant-btn-fb">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 vibrant-btn vibrant-btn-lkin">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 vibrant-btn vibrant-btn-tw">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 vibrant-btn vibrant-btn-google">
                ...
                <div class="col-lg-5 col-md-8 col-sm-10 col-xs-12 login-box mt-3 vibrant-box">
                    <form id="loginForm" role="form" method="POST" action="{{ url()->current() }}">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="panel-intro text-center">
                                <h2 class="logo-title vibrant-title">{{ t('log_in') }}</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group vibrant-form-group">
                                    <div class="text-center">
                                        <label for="login" class="col-form-label vibrant-label">{{ t('login') . ' (' . getLoginLabel() . ')' }}:</label>
                                    </div>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text vibrant-input-group-text"><i class="icon-user fa"></i></span>
                                        </div>
                                        <input id="login" name="login" type="text" placeholder="{{ getLoginLabel() }}" class="form-control{{ $loginError }} vibrant-input" value="{{ $loginValue }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group vibrant-form-group">
                                    <div class="input-group show-pwd-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text vibrant-input-group-text"><i class="icon-lock fa"></i></span>
                                        </div>
                                        <input id="password" name="password" type="password" class="form-control{{ $passwordError }} vibrant-input" placeholder="{{ t('password') }}" autocomplete="off">
                                        <span class="icon-append show-pwd">
                                            <button type="button" class="vibrant-eye-btn">
                                ...
                                <div class="form-group">
                                    <button id="loginBtn" class="btn btn-primary btn-block vibrant-btn vibrant-submit-btn"> {{ t('log_in') }} </button>
                                </div>
                            </div>
                            
                            <div class="card-footer">
                                <label class="checkbox pull-left mt-2 mb-2">
                                    <input type="checkbox" value="1" name="remember" id="remember" class="vibrant-checkbox">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description vibrant-checkbox-label"> {{ t('keep_me_logged_in') }}</span>
                                </label>
                                <div class="text-center pull-right mt-2 mb-2">
                                    <a href="{{ url('password/reset') }}" class="vibrant-link"> {{ t('lost_your_password') }} </a>
                                </div>
                    ...
                    <div class="login-box-btm text-center">
                        <p class="vibrant-signup-text">
                            ...
                            <a href="{{ \App\Helpers\UrlGen::register() }}" class="vibrant-signup-link"><strong>{{ t('sign_up') }} !</strong></a>
                        </p>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.vibrant-eye-btn').click(function() {
                ...
                var eyeIcon = $(this).find('.vibrant-eye-icon');
